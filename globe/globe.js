...
DAT.Globe = function (container, opts) {
  ...
  var distanceMaxLimit = 1000,
    distanceMinLimit = 350;
  var distance = 100000,
  ...
  function zoom(delta) {
    ...
    distanceTarget =
      distanceTarget > distanceMaxLimit ? distanceMaxLimit : distanceTarget;
    distanceTarget =
      distanceTarget < distanceMinLimit ? distanceMinLimit : distanceTarget;
  }
